 ...
 */
export function reconstructAnimeKaiCompoundFromWatchUrl(watchEpisodeId, catalogEpisode) {
    ...
    if (!m)
        return null;
    if (!Number.isFinite(catalogEpisode) || catalogEpisode < 1)
        return null;
    const epKey = m[2];
    if (/^\d+$/.test(epKey))
        return null;
...
//# sourceMappingURL=animekai-compound-from-watch.js.map