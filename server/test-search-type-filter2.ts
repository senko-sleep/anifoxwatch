...
async function testTypeFilters() {
    ...
    try {
        ...
        console.log('\n1. Searching for "a" with type: movie');
        const movieResults = await hianime.search('a', 1, { type: 'movie' });
        ...
        console.log('\n2. Searching for "a" with type: tv');
        const tvResults = await hianime.search('a', 1, { type: 'tv' });
        ...
        console.log('\n3. Searching for "a" with type: ova');
        const ovaResults = await hianime.search('a', 1, { type: 'ova' });
