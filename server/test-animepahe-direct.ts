...
async function testAnimePaheDirect() {
    console.log('🧪 Testing AnimePaheDirect source...\n');
    
    const source = new AnimePaheDirectSource();
...
testAnimePaheDirect().catch(console.error);
